...
namespace MeshIO {
    ...
    QString updateSurfaceFeatureDict(std::shared_ptr<OpenFoamDictionary> dict,
                                            const std::map<QString, SurfaceFeatureEntry>& entryMap);
    QString createSurfaceFeatureDict(const std::map<QString, SurfaceFeatureEntry>& entryMap,
    ...
    QString createSnappyHexMeshDict(const std::map<QString, SurfaceFeatureEntry>& entryMap,
