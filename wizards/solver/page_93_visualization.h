...
class VisualizationPage : public QWizardPage {
 ...
 private:
    ...
    QComboBox *m_surfaceTypeCombo, *m_surfaceFormatCombo, *m_writeControlCombo,
        *m_interpolationCombo, *m_typeCombo;
    QLineEdit *m_writeIntervalEdit;
    QListWidget *m_fieldListWidget, *m_surfaceListWidget;
    QStackedWidget *m_surfaceStack;

    const std::unordered_map<Solver::SurfaceType, QStringList>
        m_surfaceParameters = {
        {Solver::SurfaceType::patch, {"patches", "interpolate"}},
        {Solver::SurfaceType::cuttingPlane,
             {"planeType", "basePoint", "normalVector", "interpolate"}},
        {Solver::SurfaceType::isoSurface,
             {"isoField", "isoValue", "interpolate", "regularise"}},
        {Solver::SurfaceType::isoSurfaceCell,
             {"isoField", "isoValue", "interpolate", "regularise"}},
        {Solver::SurfaceType::meshedSurface,
             {"surface", "source", "interpolate"}},
        {Solver::SurfaceType::distanceSurface,
