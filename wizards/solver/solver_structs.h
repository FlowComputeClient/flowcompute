...
#ifndef WIZARDS_SOLVER_SOLVER_STRUCTS_H_
#define WIZARDS_SOLVER_SOLVER_STRUCTS_H_
...
struct ParallelConfig {
    ...
    FlowCompute::DecompositionMethod method =
        FlowCompute::DecompositionMethod::Scotch;
...
struct VisualizationConfig {
    ...
    Solver::VisWriteControlType writeControl =
        Solver::VisWriteControlType::timeStep;
    double writeInterval = 50.0;
    Solver::InterpolationType interpolationType =
        Solver::InterpolationType::cell;
    std::vector<QString> fieldNames;
    std::vector<VisualizationSurface> surfaces;
};

#endif  // WIZARDS_SOLVER_SOLVER_STRUCTS_H_
