...
#ifndef WIZARDS_POST_PROCESSING_ADD_SURFACE_DIALOG_H_
#define WIZARDS_POST_PROCESSING_ADD_SURFACE_DIALOG_H_
...
#endif  // WIZARDS_POST_PROCESSING_ADD_SURFACE_DIALOG_H_
